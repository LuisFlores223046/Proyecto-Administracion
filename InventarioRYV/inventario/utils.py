...
def actualizar_estado_equipo(equipo):
    """
    @brief Actualiza el estado de un equipo según sus rentas activas y disponibilidad.

    @details Evalúa si el equipo tiene rentas activas o unidades disponibles para
    ...
    @param equipo Equipo Instancia del modelo Equipo cuyo estado se actualizará.
