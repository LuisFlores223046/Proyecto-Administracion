...
def mis_solicitudes(request):
    """
    @brief Muestra el listado de solicitudes enviadas por el usuario autenticado.

    @details Permite que tanto el Empleado como el Administrador consulten el estado
